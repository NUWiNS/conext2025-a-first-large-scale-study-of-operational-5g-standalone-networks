...
if 1:
    ...
    if 1:
        ...
        plt.tight_layout()
        plt.savefig('../plots/yearwise/tmobile_nsa_sa_dl_xput_boston.pdf')
        plt.close()
...
if 1:
    ...
    if 1:
        ...
        plt.tight_layout()
        plt.savefig('../plots/yearwise/tmobile_nsa_sa_ul_xput_boston.pdf')
        plt.close()
...
if 1:
    ...
    plt.tight_layout()
    plt.savefig('../plots/yearwise/tmobile_nsa_sa_bw_PCI_ARFCN_boston_flattened.pdf')
    plt.close()